...
var Sound_Land : AudioClip;
static var SoundSource_Walk : AudioSource;
...
static var movementVelocity : Vector3;
...
private function UpdateFunction () {
	...
	if(!SoundSource_Walk)
	SoundSource_Walk = GameObject.Find("WalkSound").GetComponent("AudioSource");
	var runPower : float = Vector3.SqrMagnitude(movement.velocity);
